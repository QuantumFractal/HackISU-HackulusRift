<Project DefaultTargets="Build" ToolsVersion="3.5" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'Win32') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{BEB37E73-3E8D-EFFD-B586-D9DE3BF5A01B}">Debug|Win32</ProjectConfiguration>
        <ProjectConfiguration Project="{47F4DCB5-3356-9010-2A41-F729BBBC45C7}">Debug|Win32</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'Win32') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{BEB37E73-3E8D-EFFD-B586-D9DE3BF5A01B}">Release|Win32</ProjectConfiguration>
        <ProjectConfiguration Project="{47F4DCB5-3356-9010-2A41-F729BBBC45C7}">Release|Win32</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="bufferutil" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    ...
    <VCBuild Projects="C:\Users\Thomas\Documents\HackISU-HackulusRift\src\node_modules\leapjs\node_modules\ws\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|Win32" SolutionFile="C:\Users\Thomas\Documents\HackISU-HackulusRift\src\node_modules\leapjs\node_modules\ws\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'Win32') " />
    <CreateProperty Value="C:\Program Files (x86)\Microsoft Visual Studio 9.0\Common7\IDE\..\..\vc\vcpackages" Condition="'$(VCBuildToolPath)' == ''">
      <Output TaskParameter="Value" PropertyName="VCBuildToolPath" />
    </CreateProperty>
    <VCBuild Projects="C:\Users\Thomas\Documents\HackISU-HackulusRift\src\node_modules\leapjs\node_modules\ws\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|Win32" SolutionFile="C:\Users\Thomas\Documents\HackISU-HackulusRift\src\node_modules\leapjs\node_modules\ws\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'Win32') " />
  </Target>
  ...
  <Target Name="validation" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    ...
    <VCBuild Projects="C:\Users\Thomas\Documents\HackISU-HackulusRift\src\node_modules\leapjs\node_modules\ws\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|Win32" SolutionFile="C:\Users\Thomas\Documents\HackISU-HackulusRift\src\node_modules\leapjs\node_modules\ws\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'Win32') " />
    <CreateProperty Value="C:\Program Files (x86)\Microsoft Visual Studio 9.0\Common7\IDE\..\..\vc\vcpackages" Condition="'$(VCBuildToolPath)' == ''">
      <Output TaskParameter="Value" PropertyName="VCBuildToolPath" />
    </CreateProperty>
    <VCBuild Projects="C:\Users\Thomas\Documents\HackISU-HackulusRift\src\node_modules\leapjs\node_modules\ws\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|Win32" SolutionFile="C:\Users\Thomas\Documents\HackISU-HackulusRift\src\node_modules\leapjs\node_modules\ws\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'Win32') " />
  </Target>
